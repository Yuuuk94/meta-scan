          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <CardHeader className="text-center pb-4 relative z-10">
                <div
                  className={`mx-auto mb-4 w-18 h-18 rounded-2xl flex items-center justify-center group-hover:scale-110   relative ${
                    theme === "dark"
            ...
            >
              ...
              <CardHeader className="text-center pb-4 relative z-10">
                ...
                >
                  {theme === "dark" && (
                    <div className="absolute inset-0 bg-purple-400/10 rounded-2xl blur "></div>
                  )}
                  <Zap
                    className={`h-8 w-8 relative z-10 ${
            ...
            >
              ...
              <CardHeader className="text-center pb-4 relative z-10">
                ...
                >
                  {theme === "dark" && (
                    <div className="absolute inset-0 bg-pink-400/10 rounded-2xl blur "></div>
                  )}
                  <Search
                    className={`h-8 w-8 relative z-10 ${
