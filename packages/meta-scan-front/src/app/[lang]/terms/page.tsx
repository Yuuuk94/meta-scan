  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        heading: "허용되는 이용",
        body: [
          "본인이 소유했거나 스캔 권한이 있는 사이트를 대상으로 서비스를 이용해 주세요.",
      ...
      },
      {
        heading: "면책 조항",
        body: [
          "스캔 결과(점수, 진단 항목)는 참고용 정보이며 정확성·완전성을 보장하지 않습니다. 실제 SEO·성능 개선 여부는 별도로 검증해 주세요.",
      ...
      {
        heading: "문의",
        body: ["약관에 대한 문의는 legal@meta-scan.dev로 연락해 주세요."],
      },
    ],
  },
  en: {
